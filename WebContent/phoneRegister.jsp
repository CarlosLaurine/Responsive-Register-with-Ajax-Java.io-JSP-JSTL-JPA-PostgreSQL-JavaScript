...
<body>
	...
	<form action="savePhone" method="post" id="registerForm2" onsubmit=" return validateFields() " >
			...
			<li>
				...
				<table class="form-style-1">
					<tr>
						...
						<td><input type="text" id="id" name="id" readonly placeholder="USER ID (READ-ONLY VALUE)"
							value="${selectedUser.id}"></td>
						
						<td><input type="text" id="name" name="name" readonly placeholder="USER NAME (READ-ONLY VALUE)"
					...
					<tr>
						<td></td>
						<td><input type="submit" value="Submit" class="header table-header"> </td>
					</tr>
		...
		<table class="responsive-table1">
			...
			<c:forEach items="${phones}" var="phone">
				...
				<tr>
					...
					<td class="thirdCol"><c:out value="${phone.type}"></c:out></td>
					...
					<td class="fifthCol"><a href="deletePhone?action=deletePhone&phoneId=${phone.id}"><img
